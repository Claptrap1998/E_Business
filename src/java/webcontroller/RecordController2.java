...
@Named("recordController2")
@SessionScoped
public class RecordController2 implements Serializable {

    private Record current;
    private DataModel items = null;
    @EJB
    private ejb.RecordFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;


    public RecordController2() {
    }
    ...
    public static class RecordControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            RecordController2 controller = (RecordController2) facesContext.getApplication().getELResolver().
