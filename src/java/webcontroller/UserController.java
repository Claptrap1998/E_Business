...
public class UserController implements Serializable {
    ...
    public String getName_() {
        name_ = ejbFacade.find(id).getUserName();
        return name_;
    }
    ...
    public String getPassword_() {
        password_ = ejbFacade.find(id).getUserPassword();
        return password_;
    }
...
//    为什么不能用password？ 为什么最后要用edit。。。。。。actionevent是啥
    ...
    public String getAddress_() {
        address_ = ejbFacade.find(id).getUserAddr();
        return address_;
    }
    ...
    public String getTel_() {
        tel_ = ejbFacade.find(id).getUserTel();
        return tel_;
    }
    ...
    public int getBalance_() {
        balance_ = ejbFacade.find(id).getUserBalance();
        return balance_;
    }
    ...
    public String getMail_() {
        mail_ = ejbFacade.find(id).getUserMail();
        return mail_;
    }
